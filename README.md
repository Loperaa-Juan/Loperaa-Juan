...
### 🧠 **AI/ML Engineer in training** · building production ML systems · 💻 Computer Science Student · 🐧 Linux Enthusiast

Building at the intersection of **Artificial Intelligence**, **Machine Learning**, and **Scalable Systems**.

- 🛠️ **Building:** Production-minded ML systems — training, serving, and shipping models that solve real problems.
- 🔬 **Deep on:** Deep Learning architectures, model optimization, and GPU programming with **CUDA**.
- 🌱 **Next:** **Distributed Systems**, **Go**, and **MLOps** best practices.
- 🎯 **Open to:** Internships · Junior ML eng · Research collaborations
...
1. ⬆️ Pushed undefined commit(s) to [Loperaa-Juan/Actividad_2_BigData](https://github.com/Loperaa-Juan/Actividad_2_BigData)<br>
2. ⬆️ Pushed undefined commit(s) to [Loperaa-Juan/Actividad_2_BigData](https://github.com/Loperaa-Juan/Actividad_2_BigData)<br>
...
4. ⬆️ Pushed undefined commit(s) to [Loperaa-Juan/Actividad_Autos_BigData](https://github.com/Loperaa-Juan/Actividad_Autos_BigData)<br>
...
[![Hugging Face](https://img.shields.io/badge/Hugging%20Face-FFD21E?style=for-the-badge&logo=huggingface&logoColor=black)](https://huggingface.co/Juanxxo)
